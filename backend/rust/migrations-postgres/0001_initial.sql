...
CREATE TABLE plan (
    id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    group_id INTEGER NOT NULL REFERENCES server_group(id) ON DELETE RESTRICT,
...
CREATE TABLE payment_method (
    ...
    created_at BIGINT NOT NULL,
    updated_at BIGINT NOT NULL,
    CONSTRAINT uniq_payment_method_driver_uuid UNIQUE (payment, uuid),
...
CREATE TABLE users (
    ...
    group_id INTEGER REFERENCES server_group(id) ON DELETE RESTRICT,
    plan_id INTEGER REFERENCES plan(id) ON DELETE RESTRICT,
    speed_limit INTEGER,
...
CREATE TABLE gift_card_redemption (
    giftcard_id INTEGER NOT NULL REFERENCES gift_card(id) ON DELETE CASCADE,
    user_id BIGINT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
    created_at BIGINT NOT NULL,
