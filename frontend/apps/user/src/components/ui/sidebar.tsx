...
// imports/primitives instead of the registry paths; explicit
// border-sidebar-border on the desktop container — this island ships no shadcn
// base layer (`* { border-color: var(--border) }`), so the bare `border-r`
// would otherwise fall back to currentColor; and Sidebar accepts
// sheetTitle/sheetDescription so the caller can localize the mobile drawer's
// screen-reader announcement instead of canonical's hardcoded English.
