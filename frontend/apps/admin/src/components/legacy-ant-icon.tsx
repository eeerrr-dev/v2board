  ...
  return (
    ...
    >
      <svg
        ...
        focusable="false"
        className={'spin' in icon && icon.spin ? 'anticon-spin' : ''}
        data-icon={name}
        width="1em"
        height="1em"
        fill="currentColor"
...
export const LegacyLinkIcon = (props: LegacyAntIconProps) => (
  <LegacyAntIcon name="link" {...props} />
);
export const LegacyReadIcon = (props: LegacyAntIconProps) => (
  <LegacyAntIcon name="read" {...props} />
);
