...
function InputGroup({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/input-group relative flex h-10 w-full min-w-0 items-center rounded-md border border-input bg-transparent shadow-xs outline-none transition-[color,box-shadow] has-[[data-slot=input-group-control]:focus-visible]:border-ring has-[[data-slot=input-group-control]:focus-visible]:ring-[3px] has-[[data-slot=input-group-control]:focus-visible]:ring-ring/50 has-[[data-slot=input-group-control][aria-invalid=true]]:border-destructive has-[[data-slot=input-group-control][aria-invalid=true]]:ring-[3px] has-[[data-slot=input-group-control][aria-invalid=true]]:ring-destructive/20 dark:bg-input/30 dark:has-[[data-slot=input-group-control][aria-invalid=true]]:ring-destructive/40',
        className,
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'data-[align=inline-start]:order-first data-[align=inline-start]:pl-3 data-[align=inline-end]:order-last data-[align=inline-end]:pr-3',
