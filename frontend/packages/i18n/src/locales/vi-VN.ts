...
const viVNDictionary = {
  ...
  "选择其它订阅": "Chọn gói dịch vụ khác",
  "有优惠券？": "Có phiếu giảm giá?",
  "验证": "Xác minh",
  "下单": "Đặt hàng",
  "折扣": "Chiết khấu",
  "变更订阅会导致当前订阅被新订阅覆盖，请注意。": "Việc thay đổi gói dịch vụ sẽ thay thế gói hiện tại bằng gói mới, xin lưu ý.",
  "请注意，变更订阅会导致当前订阅被新订阅覆盖。": "Việc thay đổi gói dịch vụ sẽ thay thế gói hiện tại bằng gói mới, xin lưu ý.",
  ...
  "您还有未完成的订单，购买前需要先取消，确定要取消之前的订单吗？": "Bạn vẫn còn đơn đặt hàng chưa hoàn thành. Bạn cần hủy trước khi mua. Bạn có chắc chắn muốn hủy đơn đặt hàng trước đó không ?",
  "确定取消": "Đúng/không",
  ...
  "如果您已经付款，取消订单可能会导致支付失败，确定要取消订单吗？": "Nếu bạn đã thanh toán, việc hủy đơn hàng có thể khiến việc thanh toán không thành công. Bạn có chắc chắn muốn hủy đơn hàng không ?",
  ...
  "您的信用卡信息只会用于当次扣款，系统并不会保存，我们认为这是最安全的。": "Thông tin thẻ tín dụng của bạn sẽ chỉ được sử dụng cho lần thanh toán này, hệ thống sẽ không lưu thông tin đó, chúng tôi nghĩ đây à cách an toàn nhất.",
  ...
  "如果您的订阅地址或信息发生泄露可以执行此操作。重置后您的 UUID 及订阅将会变更，需要重新导入订阅。": "Nếu địa chỉ hoặc thông tin gói dịch vụ của bạn bị tiết lộ có thể tiến hành thao tác này. Sau khi reset UUID sẽ thay đổi.",
  ...
  "当你的订阅地址或账户发生泄漏被他人滥用时，可以在此重置订阅信息。避免带来不必要的损失。": "Khi đăng ký hoặc tài khoản của bạn bị rò rỉ và bị lợi dụng bởi các bên không xác định, bạn có thể đặt lại thông tin đăng ký tại đây để tránh những mất mát không đáng có.",
  ...
  "打开 Telegram 搜索": "Mở Telegram tìm kiếm",
  "向机器人发送你的": "Gửi cho bot",
  "向机器人发送您的": "Gửi cho bot",
...
const viVN = translateLegacyDictionary(zhCN, viVNDictionary) as Translations;
