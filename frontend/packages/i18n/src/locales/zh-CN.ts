const zhCN = {
  common: {
    ...
    route_load_failed: '页面加载失败',
    route_refresh_hint: '请刷新页面后重试。',
    refresh_page: '刷新页面',
    title: '标题',
    items_per_page: '条/页',
    prev_page: '上一页',
  ...
  auth: {
    ...
    login_title: '欢迎回来',
    login_description: '输入邮箱和密码继续',
    register_title: '创建账户',
    register_description: '填写信息开始使用',
    reset_title: '重置密码',
    ...
    old_password: '旧密码',
    email_code: '邮箱验证码',
    email_code_invalid: '请输入 6 位数字邮箱验证码',
    send_code: '发送',
    confirm_password: '确认密码',
    password_mismatch: '两次密码输入不同',
    code_sent: '已发送 ({{seconds}}s)',
    email_code_sent_title: '发送成功',
    email_code_sent_description: '如果没有收到验证码请检查垃圾箱。',
    invite_code: '邀请码',
    ...
    no_account: '还没有账号？',
    tos_link: '服务条款',
    tos_html: '我已阅读并同意 <terms>服务条款</terms>',
  ...
  dashboard: {
    ...
    devices_limit: '设备限制',
    reset_day: '流量重置周期',
    // Count-based keys keep their base entry (the selector type navigates the
    // real object shape) plus explicit `_one`/`_other` CLDR plural forms.
    // i18next picks the form from the active locale's plural rule; languages
    // without a one/other split (zh/ja/ko/vi) repeat the same string.
    ...
    active: '生效中',
    expired_label: '已过期',
    expires_in: '于 {{date}} 到期，距离到期还有 {{count}} 天。',
    expires_in_one: '于 {{date}} 到期，距离到期还有 {{count}} 天。',
    expires_in_other: '于 {{date}} 到期，距离到期还有 {{count}} 天。',
    copy_success: '复制成功',
    ...
    alert_open_ticket: '<strong>{{count}}</strong> 条工单正在处理中',
    alert_open_ticket_one: '<strong>{{count}}</strong> 条工单正在处理中',
    alert_open_ticket_other: '<strong>{{count}}</strong> 条工单正在处理中',
    alert_view: '立即查看',
    alert_traffic_rate: '当前已使用流量达 {{rate}}%',
    buy_reset_package: '购买流量重置包',
    new_period: '提前开启流量周期',
    new_period_success: '提前开启流量周期成功',
    buy_subscribe: '购买订阅',
  ...
  profile: {
    ...
    last_login: '上次登录',
    created_at: '注册时间',
    active_sessions: '登录设备',
    active_sessions_desc: '这些设备当前已登录你的账户，如有陌生设备可将其注销。',
    session_device: '设备',
    session_ip: 'IP 地址',
    session_login_at: '登录时间',
    session_current: '当前设备',
    session_revoke: '注销',
    session_revoke_confirm: '确定要注销该设备的登录？注销后该设备需要重新登录。',
    session_revoke_success: '已注销该设备',
    no_sessions: '暂无登录设备',
    ...
    redeem_success: '兑换成功: {{detail}}',
    redeem_balance: '账户余额 {{amount}}',
    redeem_days: '订阅时长 {{count}} 天',
    redeem_days_one: '订阅时长 {{count}} 天',
    redeem_days_other: '订阅时长 {{count}} 天',
    redeem_traffic: '套餐流量 {{traffic}} GB',
    redeem_reset: '流量已重置',
    redeem_plan_days: '订阅套餐 {{count}} 天',
    redeem_plan_days_one: '订阅套餐 {{count}} 天',
    redeem_plan_days_other: '订阅套餐 {{count}} 天',
    redeem_unknown: '未知类型',
  },
  notice: {
    title: '公告',
