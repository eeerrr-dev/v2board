...
const ANCHOR_CODES = new Map([
  ...
  ['The maximum number of creations has been reached', 'invite_code_limit_reached'],
  ...
  ['The ticket is closed and cannot be replied', 'ticket_invalid_state'],
  ['工单已关闭，无法回复', 'ticket_invalid_state'],
  ['Please wait for the technical enginneer to reply', 'ticket_invalid_state'],
  ['请等待技术支持回复', 'ticket_invalid_state'],
  ...
  // W8 reclassified the legacy-500 withdraw close-enable gate (§3.2/§3.4).
  ['Unsupported withdrawal', 'withdraw_method_unsupported'],
  ['不支持提现', 'withdraw_method_unsupported'],
