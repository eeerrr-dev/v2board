...
export const interactions = [
  ...
  {
    label: 'a11y-user-register',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-register-rich',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-forget',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-forget',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-plans',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-plans',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-plan-checkout',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-plan-checkout',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-orders',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-orders',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-node',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-node',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-traffic',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-traffic',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-invite',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-invite',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-tickets',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-tickets',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-knowledge',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-knowledge',
    sourceOnly: true,
  },
  {
    label: 'a11y-user-profile',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'user-profile',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-config',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-config',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-plans',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-plans',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-server-manage',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-server-manage',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-orders',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-orders',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-coupons',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-coupons',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-notices',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-notices',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-tickets',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-tickets',
    sourceOnly: true,
  },
  {
    label: 'a11y-admin-audit',
    run: runAccessibilitySmokeInteraction,
    scenarioLabel: 'admin-audit',
    sourceOnly: true,
  },
