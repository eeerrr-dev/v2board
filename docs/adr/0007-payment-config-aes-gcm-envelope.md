...
(`{format_version, nonce, ciphertext, tag}`,`crates/domain/src/payment_secrets.rs`):
...
- [`../../backend/rust/crates/domain/src/payment_secrets.rs`](../../backend/rust/crates/domain/src/payment_secrets.rs)
