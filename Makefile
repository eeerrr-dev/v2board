...
INTERACTION_PARITY_SCENARIOS ?= user-login-form-language user-login-language-persistence user-dashboard-header-language-dropdown user-dashboard-avatar-dropdown user-dashboard-dark-mode-persistence user-dashboard-subscribe-drawer user-dashboard-notice-carousel user-dashboard-reset-package-confirm user-dashboard-alert-links user-profile-deposit-modal user-profile-reset-subscribe-confirm user-profile-telegram-bind-modal user-profile-telegram-unbind-confirm user-profile-preference-switches user-profile-redeem-giftcard user-profile-change-password-success \
	...
	admin-plan-create-drawer admin-plan-edit-drawer admin-plan-renew-tooltip admin-config-tabs admin-theme-settings-modal admin-server-create-node-drawer admin-server-edit-node-drawer admin-server-route-create-modal admin-server-route-edit-modal admin-server-group-create-modal admin-server-group-edit-modal admin-payment-create-modal admin-payment-edit-modal \
