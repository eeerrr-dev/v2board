...
INTERACTION_PARITY_SCENARIOS ?= user-login-form-language user-login-language-persistence user-dashboard-dark-mode-persistence user-dashboard-subscribe-drawer user-dashboard-notice-carousel user-dashboard-reset-package-confirm user-dashboard-alert-links user-profile-deposit-modal user-profile-reset-subscribe-confirm user-profile-telegram-bind-modal user-profile-telegram-unbind-confirm user-profile-preference-switches user-profile-redeem-giftcard user-profile-change-password-success \
	user-plans-filter-tabs user-plan-checkout-coupon user-order-payment-method \
	user-node-table-scroll user-traffic-table-scroll user-knowledge-drawer user-invite-generate user-ticket-reply-send \
	user-ticket-create-submit admin-ticket-reply-send admin-tickets-reply-filter admin-dashboard-dark-mode-persistence admin-dashboard-commission-shortcut user-order-cancel-confirm \
	admin-plan-create-drawer admin-plan-edit-drawer admin-config-tabs admin-theme-settings-modal admin-server-create-node-drawer admin-server-edit-node-drawer admin-server-route-create-modal admin-server-route-edit-modal admin-server-group-create-modal admin-server-group-edit-modal admin-payment-create-modal admin-payment-edit-modal \
	admin-order-detail-modal admin-order-assign-modal admin-order-status-dropdown admin-order-commission-dropdown \
	admin-coupon-create-modal admin-coupon-edit-modal admin-giftcard-create-modal admin-giftcard-edit-modal admin-notice-create-modal admin-notice-edit-modal admin-knowledge-create-drawer admin-knowledge-edit-drawer admin-users-filter-input admin-user-bulk-ban-confirm admin-user-bulk-delete-confirm admin-user-create-modal admin-user-send-mail-modal admin-user-reset-secret-confirm admin-user-delete-confirm admin-user-copy-action admin-user-edit-action admin-user-assign-action admin-user-orders-action admin-user-invite-action admin-user-traffic-action
